      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            if (lane == 0 && behavior.laneType == BehaviorLaneType::LANE_CHANGE_RIGHT) {
              lane = 1;
            ...
            for (int i = 1; i <= 50 - previous_path_x.size(); i++) {
              ...
              double N = (target_dist/(0.02 * ref_vel / 2.24)); // divide by 2.24 to get mps (meters per second) from mph (miles per hour)
